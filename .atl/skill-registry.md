...
- /Users/andres/.config/opencode/skills
- /Users/andres/.gemini/skills
- /Users/andres/.gemini/antigravity/skills
- /Users/andres/.cursor/skills
- /Users/andres/.copilot/skills
- /Users/andres/.codex/skills
...
### architecture
- Path: /Users/andres/.config/opencode/skills/architecture/SKILL.md
- Trigger: Revyse backend architecture—repositories (.repo), orchestrators (.orca), and services (.service). Use when implementing or reviewing data access, business logic, or domain services.
- Rules:
...
### branch-pr
- Path: /Users/andres/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /Users/andres/.config/opencode/skills/chained-pr/SKILL.md
...
### code-quality
- Path: /Users/andres/.config/opencode/skills/code-quality/SKILL.md
- Trigger: Code quality standards—component organization, imports, error handling. Use when structuring components, organizing imports, or adding error handling.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### cognitive-doc-design
- Path: /Users/andres/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /Users/andres/.config/opencode/skills/comment-writer/SKILL.md
...
### database-and-schema
- Path: /Users/andres/.config/opencode/skills/database-and-schema/SKILL.md
- Trigger: Revyse database and schema design—tables, relations, migrations. Use when designing or changing database schema or writing migrations.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### development-workflow
- Path: /Users/andres/.config/opencode/skills/development-workflow/SKILL.md
- Trigger: Revyse development workflow—summaries, code review, HTML/UI conventions, Hatchet workers. Use when summarizing changes, reviewing code, or writing workers.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### find-skills
- Path: /Users/andres/.agents/skills/find-skills/SKILL.md
...
### go-testing
- Path: /Users/andres/.config/opencode/skills/go-testing/SKILL.md
...
### imagegen
- Path: /Users/andres/.codex/skills/.system/imagegen/SKILL.md
...
### issue-creation
- Path: /Users/andres/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /Users/andres/.config/opencode/skills/judgment-day/SKILL.md
...
### openai-docs
- Path: /Users/andres/.codex/skills/.system/openai-docs/SKILL.md
- Trigger: Use when the user asks how to build with OpenAI products or APIs and needs up-to-date official documentation with citations, help choosing the latest model for a use case, or explicit GPT-5.4 upgrade and prompt-upgrade guidance; prioritize OpenAI docs MCP tools, use bundled references only as helper context, and restrict any fallback browsing to official OpenAI domains.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### plugin-creator
- Path: /Users/andres/.codex/skills/.system/plugin-creator/SKILL.md
...
### react-components
- Path: /Users/andres/.config/opencode/skills/react-components/SKILL.md
- Trigger: Revyse React components, forms, modals, and UI primitives. Use when building or updating components, forms, Conform, or component structure.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### remix-and-routes
- Path: /Users/andres/.config/opencode/skills/remix-and-routes/SKILL.md
- Trigger: Remix routes, loaders, actions, DI container, and permissions in Revyse. Use when working on route files or route-level authorization.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: /Users/andres/.config/opencode/skills/skill-creator/SKILL.md
...
### skill-installer
- Path: /Users/andres/.codex/skills/.system/skill-installer/SKILL.md
...
### styling-and-ui
- Path: /Users/andres/.config/opencode/skills/styling-and-ui/SKILL.md
- Trigger: Revyse styling, Tailwind, and design system. Use when applying Tailwind, aligning with Figma, or working with colors, layout, and CSS.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### testing
- Path: /Users/andres/.config/opencode/skills/testing/SKILL.md
- Trigger: Unit and E2E testing practices in Revyse—fixtures, TestDIContainer, Faker. Use when writing or reviewing tests.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### typescript-and-types
- Path: /Users/andres/.config/opencode/skills/typescript-and-types/SKILL.md
- Trigger: TypeScript and type management in Revyse—strict typing, Prisma types, and type imports. Use when writing or refactoring types, loaders, or data layer code.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### validation-and-props
- Path: /Users/andres/.config/opencode/skills/validation-and-props/SKILL.md
- Trigger: Validation (Zod) and component props strategy in Revyse. Use when adding form validation, API validation, or designing component interfaces.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: /Users/andres/.config/opencode/skills/work-unit-commits/SKILL.md
